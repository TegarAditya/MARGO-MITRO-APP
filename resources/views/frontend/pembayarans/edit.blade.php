    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pembayarans.update", [$pembayaran->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="no_kwitansi">{{ trans('cruds.pembayaran.fields.no_kwitansi') }}</label>
                            <input class="form-control" type="text" name="no_kwitansi" id="no_kwitansi" value="{{ old('no_kwitansi', $pembayaran->no_kwitansi) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nominal" id="nominal" value="{{ old('nominal', $pembayaran->nominal) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="diskon" id="diskon" value="{{ old('diskon', $pembayaran->diskon) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="bayar" id="bayar" value="{{ old('bayar', $pembayaran->bayar) }}" step="1" required>
                            @if($errors->has('bayar'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bayar') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal" id="tanggal" value="{{ old('tanggal', $pembayaran->tanggal) }}" required>
