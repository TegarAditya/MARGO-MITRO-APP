...
<div class="model-products pt-3">
                    ...
                    @foreach ($items as $detail)
                        ...
                        <div class="item-product row item-product-status-{{ $po_status }}">
                            ...
                            <div class="col row justify-content-center align-self-center">
                                <div class="col-6">
                                    <label for="productCheckFile-{{ $product->id }}" class="text-sm mb-0">
                                        File Mentah
                                    </label>
                                    ...
                                    <div class="form-check">
                                        <input
                                            ...
                                            value="1"
                                            id="productCheckFile-{{ $product->id }}"
                                            {{ !$detail->file ? '' : ' checked' }}
                                        >
                                        <label class="form-check-label" for="productCheckFile-{{ $product->id }}">
                                        Sudah terima file mentah
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="d-flex justify-content-end mt-4">
        ...
        <a href="#model-tab-2" class="btn btn-info modelTabs-nav">
            Selanjutnya
        </a>
    </div>
</div>
