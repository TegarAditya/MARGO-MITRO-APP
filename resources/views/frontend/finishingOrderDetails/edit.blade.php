    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.finishing-order-details.update", [$finishingOrderDetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            @if($errors->has('finishing_order'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('finishing_order') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="order_qty" id="order_qty" value="{{ old('order_qty', $finishingOrderDetail->order_qty) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="prod_qty" id="prod_qty" value="{{ old('prod_qty', $finishingOrderDetail->prod_qty) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ongkos_satuan" id="ongkos_satuan" value="{{ old('ongkos_satuan', $finishingOrderDetail->ongkos_satuan) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ongkos_total" id="ongkos_total" value="{{ old('ongkos_total', $finishingOrderDetail->ongkos_total) }}" step="0.01" required>
