                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.invoices.update", [$invoice->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_suratjalan" id="no_suratjalan" value="{{ old('no_suratjalan', $invoice->no_suratjalan) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_invoice" id="no_invoice" value="{{ old('no_invoice', $invoice->no_invoice) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nominal" id="nominal" value="{{ old('nominal', $invoice->nominal) }}" step="1">
