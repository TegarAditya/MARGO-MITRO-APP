...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="tab-invoice">
            <form method="POST" action="{{ route('admin.invoices.returupdate', [$invoice->id]) }}" enctype="multipart/form-data" id="invoiceForm">
                @method('PUT')
                @csrf
                    ...
                    <div class="product-list-group">
                        ...
                        <div class="product-list">
                            ...
                            @if ($item['items']->count())
                                ...
                                @endphp
                                @each('admin.invoices.parts.item-invoice-detail-nopg', $sortedProducts, 'detail')
                            @endif
