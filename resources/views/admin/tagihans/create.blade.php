...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tagihans.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('saldo') ? 'is-invalid' : '' }}" type="number" name="saldo" id="saldo" value="{{ old('saldo', '0') }}" step="0.01" required>
                @if($errors->has('saldo'))
