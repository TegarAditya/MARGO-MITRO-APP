    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stock-adjustments.update", [$stockAdjustment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', $stockAdjustment->quantity) }}" step="1" required>
