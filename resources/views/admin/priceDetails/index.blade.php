...
@section('content')
@can('price_detail_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.price-details.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.priceDetail.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.priceDetail.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-PriceDetail">
            <thead>
                <tr>
                    <th width="10">
...
@can('price_detail_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.price-details.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-PriceDetail').DataTable(dtOverrideGlobals);
